...
//        final EditText etBankAcc = (EditText) findViewById(R.id.etBankAcc);
        ...
        bRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String personalCode = etPersonalCode.getText().toString();
                ...
                RegisterRequest registerRequest = new RegisterRequest(name, familyName, username, password,personalCode, responseListener);
